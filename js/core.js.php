...
var aWP = function (){
	...
	var get_throbber = function (){
			...
			if(_d[i].submit == 'TRUE'){
				...
				img.src="<?php echo $home;?>/wp-content/plugins/<?php echo AWP_BASE;?>/images/throbber"+arguments[2]+".gif";
	...
	return{
		...
		init: function(){
			...
			preload_throbber.src="<?php echo $home;?>/wp-content/plugins/<?php echo AWP_BASE;?>/images/throbber<?php echo $awpall['throbber'];?>.gif";
			preload_throbber.src="<?php echo $home;?>/wp-content/plugins/<?php echo AWP_BASE;?>/images/throbberlarge.gif";
